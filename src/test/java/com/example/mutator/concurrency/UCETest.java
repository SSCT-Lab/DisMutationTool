...
public class UCETest {
    ...
    private static final Logger logger = LogManager.getLogger(UCETest.class);

    @BeforeClass
    public static void setUp() {
        TestUtils.clearMutantAndOriginalDir();
        mutantManager = TestUtils.generateZKMutantManager(MutatorType.UCE);
        zkProject = mutantManager.getProject();
    }

    @Test
    public void testGenUCEMutant() {
