...
public class MutantUtil {
    ...
    public static void loadMutant(Mutant mutant) {
        ...
        String mutatedFileName = FileUtil.getNameWithoutExtension(mutatedFilePath) + ".java";
        String originalFilePath = mutant.getOriginalPath();
        String originalFileName = FileUtil.getNameWithoutExtension(originalFilePath) + ".java";
        logger.info("Loading " + originalFileName + " with " + mutatedFileName + "...");
        // 打印文件的diff
