...
public class BCSTest {
    ...
    private static final Logger logger = LogManager.getLogger(BCSTest.class);

    @BeforeClass
    public static void setUp() {
        TestUtils.clearMutantAndOriginalDir();
        mutantManager = TestUtils.generateZKMutantManager(MutatorType.BCS);
        zkProject = mutantManager.getProject();
    }

    @Test
    public void testGenBCSMutant() {
