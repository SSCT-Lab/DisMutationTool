...
public class RTSTest {
    ...
    private static final Logger logger = LogManager.getLogger(RTSTest.class);

    @BeforeClass
    public static void setUp() {
        TestUtils.clearMutantAndOriginalDir();
        mutantManager = TestUtils.generateZKMutantManager(MutatorType.RTS);
        zkProject = mutantManager.getProject();
    }

    @Test
    public void testGenRTSMutant() {
