...
public class IdenticalMutantFilterTest {

    private static final Logger logger = LogManager.getLogger(IdenticalMutantFilterTest.class);
    ...
    @Test
    public void testIdenticalMutantFilterWithSingleMutantType() {
        ...
        identicalMutantFilter.filter(mutants);
    }

    @Test
    public void testSyntaxMutantFilterWithAllMutantTypes() {
