...
* */
public class RSB extends MutantGen {
    private static final Logger logger = LogManager.getLogger(RSB.class);
    public static final MutatorType mutator = MutatorType.RSB;
        ...
        public List<Mutant> execute(String originalFilePath) {
            ...
            for (int i = 0; i < synchronizedStmts.size(); i++) {
                ...
                String blockContent = synchronizedStmt.getBody().toString();
