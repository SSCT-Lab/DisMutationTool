...
public class RCFTest {
    ...
    private static final Logger logger = LogManager.getLogger(RCFTest.class);

    @BeforeClass
    public static void setUp() {
        TestUtils.clearMutantAndOriginalDir();
        mutantManager = TestUtils.generateZKMutantManager(MutatorType.RCF);
        zkProject = mutantManager.getProject();
    }

    @Test
    public void testGenRCFMutant() {
